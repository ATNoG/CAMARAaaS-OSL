...
async def update_ue(
    ...
    del filtered_ue["AMBRUP"]
    del filtered_ue["AMBRDW"]
    del filtered_ue["IPV4"]
    del filtered_ue["IPV6"]
    
    print(filtered_ue)
    return JSONResponse(status_code=status.HTTP_200_OK, content={"description": "updated", "data": filtered_ue})