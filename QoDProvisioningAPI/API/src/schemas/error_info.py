...
class ErrorInfo(BaseModel):
    ...
    """ # noqa: E501
    status: StrictInt = Field(description="HTTP status code returned along with this error response")
    code: StrictStr = Field(description="Code given to this error")
    message: StrictStr = Field(description="Detailed error description")
