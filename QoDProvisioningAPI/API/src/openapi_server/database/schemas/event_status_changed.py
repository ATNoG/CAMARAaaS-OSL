...
from openapi_server.database.schemas.cloud_event import CloudEvent
from openapi_server.database.schemas.event_status_changed_all_of_data import EventStatusChangedAllOfData
try:
...
class EventStatusChanged(CloudEvent):
    """
    Event to notify a QoD provisioning status change
    """ # noqa: E501
    ...
    data: EventStatusChangedAllOfData
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EventStatusChanged from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EventStatusChanged from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": EventStatusChangedAllOfData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "time": obj.get("time")
        })
        return _obj
