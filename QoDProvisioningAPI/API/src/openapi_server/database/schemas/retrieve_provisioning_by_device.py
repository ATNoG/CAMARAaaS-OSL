...
from openapi_server.database.schemas.device import Device
try:
...
class RetrieveProvisioningByDevice(BaseModel):
    """
    Attributes to look for QoD provisioning
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RetrieveProvisioningByDevice from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RetrieveProvisioningByDevice from a dict"""
        if obj is None:
            return None
