...
class DeviceIpv4Addr(BaseModel):
    ...
    """ # noqa: E501
    public_address: Optional[StrictStr] = Field(default=None, description="A single IPv4 address with no subnet mask", alias="publicAddress")
    private_address: Optional[StrictStr] = Field(default=None, description="A single IPv4 address with no subnet mask", alias="privateAddress")
    public_port: Optional[Annotated[int, Field(le=65535, strict=True, ge=0)]] = Field(default=None, description="TCP or UDP port number", alias="publicPort")
    __properties: ClassVar[List[str]] = ["publicAddress", "privateAddress", "publicPort"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DeviceIpv4Addr from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DeviceIpv4Addr from a dict"""
        if obj is None:
            return None
