...
from openapi_server.models.status_changed import StatusChanged
...
class EventStatusChangedAllOfData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["provisioningId", "status", "statusInfo"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EventStatusChangedAllOfData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EventStatusChangedAllOfData from a dict"""
        if obj is None:
            return None
