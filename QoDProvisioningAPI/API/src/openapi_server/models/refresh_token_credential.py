...
from openapi_server.models.sink_credential import SinkCredential
try:
...
class RefreshTokenCredential(SinkCredential):
    ...
    refresh_token: StrictStr = Field(description="REQUIRED. An refresh token credential used to acquire access tokens.", alias="refreshToken")
    refresh_token_endpoint: StrictStr = Field(description="REQUIRED. A URL at which the refresh token can be traded for an access token.", alias="refreshTokenEndpoint")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of RefreshTokenCredential from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of RefreshTokenCredential from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "refreshTokenEndpoint": obj.get("refreshTokenEndpoint")
        })
        return _obj
